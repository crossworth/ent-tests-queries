...
func (nu *NodeUpdate) SetFrom(s string) *NodeUpdate {
	nu.mutation.SetFrom(s)
	return nu
}

// SetTo sets the "to" field.
func (nu *NodeUpdate) SetTo(s string) *NodeUpdate {
	nu.mutation.SetTo(s)
	return nu
}
...
// SetFrom sets the "from" field.
func (nuo *NodeUpdateOne) SetFrom(s string) *NodeUpdateOne {
	nuo.mutation.SetFrom(s)
	return nuo
}

// SetTo sets the "to" field.
func (nuo *NodeUpdateOne) SetTo(s string) *NodeUpdateOne {
	nuo.mutation.SetTo(s)
	return nuo
}
...
func (nuo *NodeUpdateOne) sqlSave(ctx context.Context) (_node *Node, err error) {
	...
	if value, ok := nuo.mutation.To(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: node.FieldTo,
